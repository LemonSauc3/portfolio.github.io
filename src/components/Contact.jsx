    ...
    return (
        <div class="w-full max-w-xs">
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <div class="mb-4">
                    <label class="block text-gray-700 text-xs md:text-sm font-bold mb-2" for="Name">Name</label>
                ...
                <div class="mb-6">
                    <label class="block text-gray-700 text-xs md:text-sm font-bold mb-2" for="Email">Email</label>
                ...
                <div class="mb-4">
                    <textarea placeholder="Message" class="text-gray-700 text-xs md:text-sm shadow appearance-none border border-blue-500 rounded w-full py-2 px-3" />
                </div>
                <div class="mb-6">
